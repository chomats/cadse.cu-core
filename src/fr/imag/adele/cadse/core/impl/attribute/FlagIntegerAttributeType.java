 ...
 */
public class FlagIntegerAttributeType extends IntegerAttributeType implements IAttributeType<Integer> {
	 ...
	 *            the value
	 */
	public FlagIntegerAttributeType(CompactUUID id, String name, int flag, String value) {
		super(id, flag, name, null, null, value);
	}

	public FlagIntegerAttributeType(ItemDelta item) {
		super(item);
	}
